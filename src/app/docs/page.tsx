          ...
          >
            ...
            >
              <p className="text-base sm:text-lg leading-relaxed text-gray-700">
                ...
                individuals. It features a browser extension that captures chat
                data, a backend that processes insights using GenAI (Gemini),
                and a Next.js frontend to display analytics interactively. The
                system includes secure authentication (Clerk), a token-based
                credit system, and optional automation features.
              </p>
            </div>
          </div>
        </section>
